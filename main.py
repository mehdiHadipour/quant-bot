#!/usr/bin/env python3
"""
🚀 AI Quant Bot v25.2 - "Why No Signal?" Diagnostic Logging
...
from config import SYMBOLS, ATR_SL_MULTIPLIER, ATR_TP_MULTIPLIER, RISK_PERCENT_PER_TRADE, MAX_CONCURRENT_TRADES
...
"""
    ...
    if funding_rate is not None:
        msg += f"💸 Funding Rate: {funding_rate * 100:+.4f}٪ (هر ۸ ساعت)\n"
