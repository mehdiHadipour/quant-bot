...
# Ichimoku Kinko Hyo (9/26/52 cloud, Tenkan/Kijun cross, Chikou span) as a
# weighted component of total_score, same as trend/momentum/etc -- not a
# hard gate. See indicators.compute_ichimoku() for the exact scoring.
ICHIMOKU_ENABLED = _str_env("ICHIMOKU_ENABLED", "1").strip().lower() not in {"0", "false", "no", "off"}
