...
MAX_SAME_DIRECTION_OPEN = _positive_int_env("MAX_SAME_DIRECTION_OPEN", 2, minimum=0)
# Signal-quality gates. Tune only after out-of-sample validation.
...
MIN_SIGNAL_SCORE = _bounded_float_env("MIN_SIGNAL_SCORE", 28.0, 0.0, 200.0)
