...
SYMBOLS = [
    ...
    for s in _str_env(
        "SYMBOLS",
        # V27.21/V27.22 symbol policy, based on the user's real (demo-
        # account) trading results, not an independent backtest finding
        # — none of these were ever part of the historical CSV data
        # actually backtested in this project except BTCUSDT/ETHUSDT/
        # SOLUSDT. Fully removed: BTCUSDT, ETHUSDT, XRPUSDT, ADAUSDT,
        # SUIUSDT, TONUSDT. Kept but restricted to SELL-only (see
