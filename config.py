...
# بعد از اینکه یک معامله با ضرر (LOSS) بسته شد، ربات به‌مدت این تعداد چرخه (هر چرخه ۱۵
# دقیقه) دیگر سیگنال جدیدی روی همان نماد باز نمی‌کند. برای غیرفعال‌کردن، مقدار 0 بگذارید.
